...
if __name__ == "__main__":
    ...
    ip = "0.0.0.0"
    node_port_start = 9010
    api_port_start = 9050

    # Create the first node with the first key file
    ...
    # Create the second node with the second key file
    ...
    # Create the remaining nodes without key files
